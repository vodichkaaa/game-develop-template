...
namespace VContainer.Editor.Diagnostics
{
    ...
    public sealed class VContainerDiagnosticsInfoTreeView : TreeView
    {
        ...
        private const string SessionStateKeySortedColumnIndex = "VContainer.Editor.DiagnosticsInfoTreeView:sortedColumnIndex";
        private static readonly MultiColumnHeaderState.Column[] Columns =
        {
            ...
            new MultiColumnHeaderState.Column
            {
                headerContent = new GUIContent("ContractTypes"),
                canSort = false
            },
            new MultiColumnHeaderState.Column
            {
                headerContent = new GUIContent("Lifetime"),
                width = 15f
            },
            new MultiColumnHeaderState.Column
            {
                headerContent = new GUIContent("Register"),
                width = 15f
            },
            new MultiColumnHeaderState.Column
            {
